...
{
    public class GerenciaPrazoDasTarefasHandlerExeculte
    {
        [Fact]
        public void QuandoTarefasEstiveremAtrasadasDeveMudarStatus()
        {
            ...
            Assert.Equal(9, tarefasEmAtraso.Count());
        }
        ...
        {
            //Arrange
            var casaCateg = new Categoria(2, "Dummy");
            ...
            var tarefas = new List<Tarefa> 
            {
                 new Tarefa(1, "Tirar lixo", casaCateg, new DateTime(2018,12,31), null, StatusTarefa.Criada),
                 new Tarefa(4, "Fazer o almoço", casaCateg, new DateTime(2017,12,1), null, StatusTarefa.Criada),
                 new Tarefa(9, "Ir à academia", casaCateg, new DateTime(2018,12,31), null, StatusTarefa.Criada),
            };
